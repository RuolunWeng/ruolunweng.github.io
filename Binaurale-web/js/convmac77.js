...
// create FAUST web audio api context
  ...
  var spilter = audioCtx.createChannelSplitter(18);
...
function finishedLoading(bufferList) {
  ...
  for (var i = 19; i <= 36; i++) { 
    ...
    soundSourceR[i-18] = audioCtx.createBufferSource();
...
dsp.setHandler (
      function() { 
         var value = dsp.getParamValue( "/0x00/visual");
         document.getElementById("vmeter").innerHTML = "Azimuth:"+value;
         //console.log(value); 
        }
        );
...
var faustParametre ={};
  ...
  faustParametre.azimuth = function(element){
    ...
    azimuthOut.innerHTML = "Azimuth_RANGE=" + azimuth;
  };
