...
// create FAUST web audio api context
  ...
  var spilter = audioCtx.createChannelSplitter(3);
  //dsp.connect(spilter);
  //console.log(spilter);
  ...
  */
  ...
  ajaxRequestL2.open('GET', '../hrir/IRC_1002_R_R0195_T240_P000_L.wav', true);
  ...
  ajaxRequestR2.open('GET', '../hrir/IRC_1002_R_R0195_T240_P000_R.wav', true);
  ...
  ajaxRequestL3.open('GET', '../hrir/IRC_1002_R_R0195_T120_P000_L.wav', true);
  ...
  ajaxRequestR3.open('GET', '../hrir/IRC_1002_R_R0195_T120_P000_R.wav', true);
...
function convChange() {
  ...
  if(convSetting == "convolver") {
    ...
    dsp.setParamValue("/0x00/GrainSize",1000);
    dsp.setParamValue("/0x00/lfo",0.3);
