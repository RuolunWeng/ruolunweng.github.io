...
var ModuleClass = (function () {
    ...
    ModuleClass.prototype.createDSP = function (factory,audioContext,bufferSize) {
        ...
        try {
            if (factory != null) {
                ...
                //faust.createDSPInstance(factory, audioContext, bufferSize, this.activateDSP);
                //faust.createDSPInstance(factory, audioContext, bufferSize, function(dsp){this.moduleFaust.fDSP = dsp;});
    ...
    ModuleClass.prototype.setFaustInterfaceControles = function (SVGinterfaceCallback) {
        ...
        this.moduleControles = moduleFaustInterface.parseFaustJsonUI(JSON.parse(_this.moduleFaust.fDSP.getJSON()).ui, this);
    };
...
var ModuleFaust = (function () {
    ...
    ModuleFaust.prototype.setDSP = function (dsp) {
        this.fDSP = dsp;
    };
