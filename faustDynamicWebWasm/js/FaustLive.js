...
var save_state = true;
//var libraries_url = "http://192.168.1.102:8000/libraries/";
var libraries_url = "http://allenweng.000webhostapp.com/faustDynamicWebWasm/libraries/";
var module = null;
    ...
    if (poly_flag === "ON") {
      ...
      faust.createDSPFactory(dsp_code,
                             ...
                             function (factory) {
                                ...
                                faust.createDSPInstance(factory, audio_context, buffer_size, activateNewDSP);
                             });
...
function activateNewDSP(dsp)
{
    if (dsp) {

			module = new ModuleClass("Dummy",dsp);
			module.moduleFaust.setSource(dsp_code);

			//module.moduleFaust.setDSP(dsp);
