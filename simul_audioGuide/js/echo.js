...
function echoModule(global, foreign, buffer) {
	...
	function getNumInputsechoSIG0(dsp) {
		dsp = dsp | 0;
		return 0;
	}
	
	function getNumOutputsechoSIG0(dsp) {
		dsp = dsp | 0;
		return 1;
	}
	
	function instanceInitechoSIG0(dsp, samplingFreq) {
		dsp = dsp | 0;
	...
	function fillechoSIG0(dsp, count, output) {
		dsp = dsp | 0;
		count = count | 0;
		output = output | 0;
		var i = 0;
	...
	function classInit(dsp, samplingFreq) {
		dsp = dsp | 0;
		samplingFreq = samplingFreq | 0;
		instanceInitechoSIG0(dsp, (samplingFreq | 0));
		fillechoSIG0(dsp, 512, (dsp + 0 | 0));
	...
	function instanceResetUserInterface(dsp) {
		...
		HEAPF[dsp + 4737200 >> 2] = 800.;
		HEAPF[dsp + 4737212 >> 2] = 0.800000012;
		HEAPF[dsp + 4737220 >> 2] = 75.;
		HEAPF[dsp + 4737228 >> 2] = 0.;
	...
	function compute(dsp, count, inputs, outputs) {
		...
		fSlow1 = +(0.00124999997 * +(max_f(0., +(+(fSlow0) + -0.100000001))));
		...
		for (i = 0; (((i | 0) < (count | 0)) | 0); i = (((i | 0) + 1) | 0)) {
			...
			fTemp2 = +(1. - +(HEAPF[dsp + 4737060 + (0 << 2) >> 2]));
			fTemp3 = +(+(HEAPF[input0 + ((i | 0) << 2) >> 2]));
			HEAPF[dsp + 4737084 + (0 << 2) >> 2] = +(+(fSlow3) + +(0.980000019 * +(HEAPF[dsp + 4737084 + (1 << 2) >> 2])));
			fTemp4 = +(+(fTemp3) + +(+(HEAPF[dsp + 4720652 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (HEAP32[dsp + 2052 >> 2] | 0)) | 0) & 2047) | 0) << 2) >> 2]) * +(HEAPF[dsp + 4737084 + (0 << 2) >> 2])));
			HEAPF[dsp + 4196364 + ((((HEAP32[dsp + 2048 >> 2] | 0) & 65535) | 0) << 2) >> 2] = +(fTemp4);
			...
			fTemp5 = +(+(HEAPF[dsp + 4737100 + (0 << 2) >> 2]) + 0.5);
			fTemp6 = +(+(fSlow5) * +(fTemp5));
			iTemp7 = ~~(+(fTemp6));
			iTemp8 = (((iTemp7 | 0) & 65535) | 0);
			fTemp9 = +(floorf(+(fTemp6)));
			fTemp10 = +(+(fTemp9) + +(1. - +(fTemp6)));
			fTemp11 = +(+(fTemp6) - +(fTemp9));
			iTemp12 = (((((iTemp7 | 0) + 1) | 0) & 65535) | 0);
			fTemp13 = +(max_f(0., +(min_f(1., +(fmodf(+(+(HEAPF[dsp + 4737100 + (0 << 2) >> 2]) + 1.), 1.))))));
			fTemp14 = +(+(fSlow5) * +(fTemp13));
			iTemp15 = ~~(+(fTemp14));
			iTemp16 = (((iTemp15 | 0) & 65535) | 0);
			fTemp17 = +(floorf(+(fTemp14)));
			fTemp18 = +(+(fTemp17) + +(1. - +(fTemp14)));
			fTemp19 = +(+(fTemp14) - +(fTemp17));
			iTemp20 = (((((iTemp15 | 0) + 1) | 0) & 65535) | 0);
			fTemp21 = +(+(+(+(+(HEAPF[dsp + 4196364 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp8 | 0)) | 0) & 65535) | 0) << 2) >> 2]) * +(fTemp10)) + +(+(fTemp11) * +(HEAPF[dsp + 4196364 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp12 | 0)) | 0) & 65535) | 0) << 2) >> 2]))) * +(HEAPF[dsp + 0 + (((max_i(0, ((min_i(511, ~~(+(512. * +(fTemp5))))) | 0))) | 0) << 2) >> 2])) + +(+(+(+(HEAPF[dsp + 4196364 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp16 | 0)) | 0) & 65535) | 0) << 2) >> 2]) * +(fTemp18)) + +(+(fTemp19) * +(HEAPF[dsp + 4196364 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp20 | 0)) | 0) & 65535) | 0) << 2) >> 2]))) * +(HEAPF[dsp + 0 + (((max_i(0, ((min_i(511, ~~(+(512. * +(fTemp13))))) | 0))) | 0) << 2) >> 2])));
			HEAPF[dsp + 2060 + ((((HEAP32[dsp + 2048 >> 2] | 0) & 524287) | 0) << 2) >> 2] = +(fTemp21);
			iTemp22 = ((~~(+(HEAPF[dsp + 4737068 + (0 << 2) >> 2])) & 524287) | 0);
			fTemp23 = +(+(fTemp2) * +(HEAPF[dsp + 2060 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp22 | 0)) | 0) & 524287) | 0) << 2) >> 2]));
			iTemp24 = ((~~(+(HEAPF[dsp + 4737076 + (0 << 2) >> 2])) & 524287) | 0);
			fTemp25 = +(+(HEAPF[dsp + 4737060 + (0 << 2) >> 2]) * +(HEAPF[dsp + 2060 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp24 | 0)) | 0) & 524287) | 0) << 2) >> 2]));
			HEAPF[dsp + 4737108 + (0 << 2) >> 2] = +(+(fTemp25) + +(fTemp23));
			HEAPF[dsp + 4737116 + (0 << 2) >> 2] = +(+(HEAPF[dsp + 4737192 >> 2]) * +(+(+(fTemp23) + +(+(+(HEAPF[dsp + 4737232 >> 2]) * +(HEAPF[dsp + 4737116 + (1 << 2) >> 2])) + +(fTemp25))) - +(HEAPF[dsp + 4737108 + (1 << 2) >> 2])));
			...
			HEAPF[output0 + ((i | 0) << 2) >> 2] = +(+(+(+(+(fTemp0) * +(HEAPF[dsp + 4720652 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - 0) | 0) & 2047) | 0) << 2) >> 2])) + +(+(fTemp3) * +(fTemp26))) * +(fTemp27)));
			...
			fTemp30 = +(+(+(HEAPF[dsp + 0 + (((max_i(0, ((min_i(511, ~~(+(512. * +(fTemp5))))) | 0))) | 0) << 2) >> 2]) * +(+(+(fTemp10) * +(HEAPF[dsp + 4458508 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp8 | 0)) | 0) & 65535) | 0) << 2) >> 2])) + +(+(fTemp11) * +(HEAPF[dsp + 4458508 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp12 | 0)) | 0) & 65535) | 0) << 2) >> 2])))) + +(+(HEAPF[dsp + 0 + (((max_i(0, ((min_i(511, ~~(+(512. * +(fTemp13))))) | 0))) | 0) << 2) >> 2]) * +(+(+(fTemp18) * +(HEAPF[dsp + 4458508 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp16 | 0)) | 0) & 65535) | 0) << 2) >> 2])) + +(+(fTemp19) * +(HEAPF[dsp + 4458508 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp20 | 0)) | 0) & 65535) | 0) << 2) >> 2])))));
			HEAPF[dsp + 2099212 + ((((HEAP32[dsp + 2048 >> 2] | 0) & 524287) | 0) << 2) >> 2] = +(fTemp30);
			fTemp31 = +(+(HEAPF[dsp + 4737060 + (0 << 2) >> 2]) * +(HEAPF[dsp + 2099212 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp24 | 0)) | 0) & 524287) | 0) << 2) >> 2]));
			fTemp32 = +(+(fTemp2) * +(HEAPF[dsp + 2099212 + ((((((HEAP32[dsp + 2048 >> 2] | 0) - (iTemp22 | 0)) | 0) & 524287) | 0) << 2) >> 2]));
...
function getSizeecho() {
	return 4737244;
}

function getPathTableecho() {
	var pathTable = [];
...
function getJSONecho() {
	return "{  \"name\": \"fst_harmo_delayfb\",  \"inputs\": \"2\",  \"outputs\": \"2\",  \"meta\": [    { \"author\": \"Christophe Lebreton\" },   { \"basics.lib/name\": \"Faust Basic Element Library\" },   { \"basics.lib/version\": \"0.0\" },   { \"copyright\": \"(c)GRAME 2015\" },   { \"delays.lib/name\": \"Faust Delay Library\" },   { \"delays.lib/version\": \"0.0\" },   { \"filters.lib/name\": \"Faust Filters Library\" },   { \"filters.lib/version\": \"0.0\" },   { \"license\": \"BSD\" },   { \"maths.lib/author\": \"GRAME\" },   { \"maths.lib/copyright\": \"GRAME\" },   { \"maths.lib/license\": \"LGPL with exception\" },   { \"maths.lib/name\": \"Faust Math Library\" },   { \"maths.lib/version\": \"2.0\" },   { \"name\": \"fst_harmo_delayfb\" },   { \"signals.lib/name\": \"Faust Signal Routing Library\" },   { \"signals.lib/version\": \"0.0\" },   { \"version\": \"1.02\" }  ],  \"ui\": [    {    \"type\": \"vgroup\",    \"label\": \"0x00\",    \"items\": [      {      \"type\": \"vslider\",      \"label\": \"delay0\",      \"address\": \"/0x00/delay0\",      \"init\": \"800\",      \"min\": \"1\",      \"max\": \"10000\",      \"step\": \"1\"     },     {      \"type\": \"vslider\",      \"label\": \"fback0\",      \"address\": \"/0x00/fback0\",      \"init\": \"0.8\",      \"min\": \"0\",      \"max\": \"0.99\",      \"step\": \"0.01\"     },     {      \"type\": \"vslider\",      \"label\": \"izone\",      \"address\": \"/0x00/izone\",      \"init\": \"0\",      \"min\": \"0\",      \"max\": \"1\",      \"step\": \"0.001\"     },     {      \"type\": \"vslider\",      \"label\": \"pitch0\",      \"address\": \"/0x00/pitch0\",      \"init\": \"0\",      \"min\": \"-3600\",      \"max\": \"3600\",      \"step\": \"1\"     },     {      \"type\": \"vslider\",      \"label\": \"window\",      \"address\": \"/0x00/window\",      \"init\": \"75\",      \"min\": \"1\",      \"max\": \"500\",      \"step\": \"1\"     }    ]   }  ] } ";
}

function metadataecho(m) {
...
faust.echo = function (context, buffer_size) {
    ...
    var jon_object = JSON.parse(getJSONecho());
    ...
    var memory_size = pow2limit(getSizeecho() + (numIn + numOut) * (ptr_size + (buffer_size * sample_size)));
    ...
    // ASM module
    var factory = echoModule(window, window.Math, HEAP);
    console.log(factory);
 
    var pathTable = getPathTableecho();
